...
# ===== Reading the graph ====== #
g <- read.graph(file="/home/rnmandge/BI/CommunityDetection/data/fb_caltech_small_edgelist.txt", format = c("edgelist"))

# ===== Read communities file ==== #
comm = integer(vcount(g))

conn <- file("/home/rnmandge/BI/CommunityDetection/communities.txt", open="r")
...
attrData <- read.csv("/home/rnmandge/BI/CommunityDetection/data/fb_caltech_small_attrlist.csv")
